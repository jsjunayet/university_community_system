...
const Tours = () => {
  ...
  const availableTours = [
    {
      ...
      description: 'Explore the rich history and beautiful architecture of our century-old campus.',
      date: '2024-02-18',
      time: '10:00',
      duration: 2.5,
      maxParticipants: 20,
      ...
      route: ['Historic Building', 'Library', 'Memorial Garden', 'Clock Tower', 'Administration Hall'],
      difficulty: 'Easy',
    ...
    },
    {
      ...
      description: 'Get an inside look at cutting-edge research facilities and laboratories.',
      date: '2024-02-22',
      time: '14:00',
      duration: 3,
      maxParticipants: 15,
      ...
      route: ['Physics Lab', 'Chemistry Lab', 'Innovation Center', 'Research Wing', 'Tech Hub'],
      difficulty: 'Moderate',
    ...
    },
    {
      ...
      description: 'Discover the cultural landmarks and hidden gems of our vibrant city.',
      date: '2024-02-25',
      time: '09:00',
      duration: 4,
      maxParticipants: 25,
      ...
      route: ['Museum Quarter', 'Art District', 'Historic Market', 'Cultural Center', 'Riverside Park'],
      difficulty: 'Moderate',
  ...
  const handleJoinTour = (tourId: string) => {
    toast({
      ...
      description: "You've been registered for the tour. Check your email for confirmation details.",
    });
  };
      ...
      <div className="bg-gradient-accent text-white p-6 rounded-lg">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-white/80">Explore campus and city with guided tours and fellow community members</p>
          </div>
        </div>
      </div>
        ...
        <TabsContent value="available" className="space-y-6">
          ...
          <div className="grid gap-6">
            {availableTours.map((tour) => (
              <Card key={tour.id} className="hover:shadow-medium transition-shadow">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span>{tour.time} ({tour.duration}h)</span>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="text-right ml-6">
                      ...
                      <div className="space-y-2">
                        <Button 
                          ...
                          className="w-full"
                        >
                          {tour.currentParticipants >= tour.maxParticipants ? 'Full' : 'Join Tour'}
                        </Button>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <Badge variant={getStatusColor(tour.confirmationStatus)}>
                            {tour.confirmationStatus}
                          </Badge>
                          <Badge variant={tour.status === 'completed' ? 'secondary' : 'outline'}>
                            {tour.status}
                          </Badge>
                        </div>
                      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">Confirm your attendance 24 hours before</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-university-green" />
                <span className="text-sm">Arrive at meeting point 10 minutes early</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-university-green" />
              ...
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-university-green" />
                <span className="text-sm">Check weather and dress appropriately</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-university-green" />
                <span className="text-sm">Bring water and snacks for longer tours</span>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
