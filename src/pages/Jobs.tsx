...
import { Plus, Search, MapPin, Calendar, Users, Building } from 'lucide-react';
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="requirements" placeholder="React, TypeScript, Node.js" />
                </div>
                ...
                return (
                  <Card key={app.id}>
                    ...
                    <CardContent>
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="text-sm">Applied: {app.appliedDate.toLocaleDateString()}</p>
                  ...
                  return (
                    <div key={app.id} className="border rounded-lg p-4">
                      ...
                      <div className="mt-3 flex space-x-2">
                        <div className={`w-3 h-3 rounded-full ${app.status === 'pending' ? 'bg-yellow-500' : 'bg-green-500'}`}></div>
                        <div className={`w-3 h-3 rounded-full ${['reviewing', 'shortlisted', 'hired'].includes(app.status) ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                        <div className={`w-3 h-3 rounded-full ${['shortlisted', 'hired'].includes(app.status) ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                        <div className={`w-3 h-3 rounded-full ${app.status === 'hired' ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                      </div>
                    </div>
                  );
                })}
