        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
              Your Complete
              <span className="bg-gradient-hero bg-clip-text text-transparent"> University </span>
              Community Platform
            </h1>
            
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Connect students, alumni, and administrators in one powerful platform. 
              From blood donation drives to job opportunities, events to emergency help - 
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 animate-fade-in">
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-foreground mb-1">Blood Donation</h3>
              <p className="text-xs text-muted-foreground">Emergency & regular drives</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-xs text-muted-foreground">RSVP & participation</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-xs text-muted-foreground">Campus & city exploration</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-xs text-muted-foreground">Applications & tracking</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-foreground mb-1">Messaging</h3>
